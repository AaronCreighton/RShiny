# file for database genetic functions used across multiple modules.


# notes on file naming:
# util: utility, purpose is for general utility.
# f: function, standard functions.


## automatically wrap any SQL statements within tryCatch + error handling script
util_f_sql_transaction <- function(gr, connection, func, action){
  tryCatch(
    pool::poolWithTransaction(connection, func),
    error = function(e){
      gr$errorHandling$action = action
      gr$errorHandling$error = paste(e)
